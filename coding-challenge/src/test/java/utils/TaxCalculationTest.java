...
public class TaxCalculationTest {
  ...
  public void test_calculateTax() throws InvalidInputException {
    ...
    Person marriedPersonPtkp =
        Person.builder().monthlySalary(6000000).isMarried(true).numberOfChildren(3).build();
    Person singlePerson = Person.builder().monthlySalary(25000000).isMarried(false).build();
    Person marriedPersonWithoutChild =
        Person.builder().monthlySalary(30000000).isMarried(true).numberOfChildren(0).build();
    Person marriedPersonWithOneChild =
        Person.builder().monthlySalary(35000000).isMarried(true).numberOfChildren(1).build();

    assertThrows(
        InvalidInputException.class, () -> TaxCalculation.calculateTax(personWithoutSalary));
